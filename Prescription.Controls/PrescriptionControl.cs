...
using Prescription.Controls.Action;
using Prescription.Controls.Entity;

namespace Prescription.Controls
{
    ...
    public partial class PrescriptionControl : UserControl, IPrescriptionControl, IPrescription
    {
        ...
        {
            BaseControls.Licensing.ComponentLicense lic = LicenseManager.Validate(typeof(PrescriptionControl), this) as BaseControls.Licensing.ComponentLicense;
            if (lic != null)
            {
                _isDemo = lic.IsDemo;
                if (_isDemo)
